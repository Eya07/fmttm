...
$nbArticles=$mediaC->NbMedias($_SESSION['i']);
// On calcule le nombre de pages total
$pages = ceil($nbArticles / $parPage);
$premier = ($currentPage * $parPage) - $parPage; 
$mediaC=new MediaC();
$listeMedia=$mediaC->afficherMediasParUser($_SESSION['i'],$premier,$parPage);
...
?>
          ...
          <div class="titre2" ><a href="Logout.php" style="color:white "> Log Out </a></div>
