...
$pdoStat=$conn->prepare('SELECT * FROM vols ORDER BY id DESC ');
$pdoStat2=$conn->prepare('SELECT * FROM destination ORDER BY id DESC');
$pdoStat3=$conn->prepare('SELECT * FROM fusee ORDER BY id DESC');
...
<br>
      <a href="index2.php#section4" style="width: 300px; height: 50px;font-size:40px ;  color:white; margin-left:50px;
      background-color: #1b1e21 ;padding:5px 10px;  border-radius: 10px;" > Trie Croissant</a>
<br>
