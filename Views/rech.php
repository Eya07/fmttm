...
$pdoStat4=$conn->prepare('SELECT * FROM vols');


$execute= $pdoStat4->execute();


$vols=$pdoStat4->fetchAll();
...
?>
      ...
      <html lang="en">
        <head>
          ...
          <!--      a modifier   -->
           <link rel="stylesheet" href="../assets_index/css/votePageCSS.css" />
        ...
        <body>
          <div id="page-wraper">
           ...
           <div>
               ...
               <br>
                       <input type="text" placeholder="Numero du vol" name="id" required>
...
if($vol['id']==$id){
?>
                  <h5> vol: <?= $vol['id']?> | <?=  $vol['duree_vol'] ?> heures | date : <?= $vol['date_vol'] ?> | Mars
                ...
                <br><br><br><br><br><br>
                 <a href="index.php" style="color:white; font-size:30px">Retour à la page d'acceuil</a>
                </div>
